...
# main.py file
import mymodule
print(mymodule.generate_full_name('Marek', 'Bukoski')) # Marek Bukoski
```
...
print(generate_full_name('Asabneh','Bukoski'))
...
print(fullname('Asabneh','Bukoski'))
print(total(1, 9))
mass = 100;
weight = mass * g
print(weight)
...
```sh
python script.py Marek 30DaysOfPython
```

The result:

```sh
Welcome Marek. Enjoy  30DayOfPython challenge! 
```
