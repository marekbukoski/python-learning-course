...
```py
 lst = ['Marek', 250, True, {'country':'Finland', 'city':'Helsinki'}] # list containing different data types
```
...
1. Find the middle country(ies) in the [countries list](https://github.com/Marek/30-Days-Of-Python/tree/master/data/countries.py)
