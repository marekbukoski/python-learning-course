<div align="center">
  ...
  <a class="header-badge" target="_blank" href="https://www.linkedin.com/in/Marek/">
  <img src="https://img.shields.io/badge/style--5eba00.svg?label=LinkedIn&logo=linkedin&style=social">
  </a>
  <a class="header-badge" target="_blank" href="https://twitter.com/Marek">
  <img alt="Twitter Follow" src="https://img.shields.io/twitter/follow/Marek?style=social">
  </a>

<sub>Author:
<a href="https://www.linkedin.com/in/Marek/" target="_blank">Marek Bukoski</a><br>
...
1. Go to the data folder and use the [countries.py](https://github.com/Marek/30-Days-Of-Python/blob/master/data/countries.py) file. Loop through the countries and extract all the countries containing the word _land_.
1. This is a fruit list, ['banana', 'orange', 'mango', 'lemon'] reverse the order using loop.
2. Go to the data folder and use the [countries_data.py](https://github.com/Marek/30-Days-Of-Python/blob/master/data/countries-data.py) file. 
