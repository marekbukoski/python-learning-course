...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Marek','Bukoski'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Marek', lastname = 'Bukoski'))
...
def print_name(firstname):
    return firstname
print_name('Marek') # Marek

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Marek', lastname='Bukoski')
```
...
def generate_full_name (first_name = 'Marek', last_name = 'Bukoski'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Marek','Brook','David','Eyob'))
```
