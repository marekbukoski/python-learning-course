...
```py
first_name, last_name, country, age, is_married = 'Marek', 'Bukoski', 'Helsink', 250, True
...
first_name = 'Marek'     # str
last_name = 'Bukoski'       # str
country = 'Finland'         # str
city= 'Helsinki'            # str
age = 250                   # int, it is not my real age, don't worry about it

# Printing out types
print(type('Marek'))     # str
...
print(type({'name':'Marek','age':250, 'is_married':250}))    # dict
